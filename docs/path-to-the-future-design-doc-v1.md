...
| **42** (v1.6) | Multiple-choice — one question (*"What is the answer to the ultimate question of life, the universe, and everything?"*), four options, order shuffled per mount, binary right/wrong | Arcade-only — no scheduled slot |
...
**42 (v1.6).** The smallest minigame in the codebase. One question
(*"What is the answer to the ultimate question of life, the universe,
and everything?"*), four options shuffled per mount — `7`, `42`, `1138`,
`∞`. Binary outcome:
