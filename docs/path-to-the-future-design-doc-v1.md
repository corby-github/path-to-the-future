...
| `tight-pickets` | Tight pickets | universal | expert | 5 narrow oscillators packed tight at x=510..870 (~90 px center-to-center, all right-half), period 1.5 s, 72° phase wave. v2.0.24 — amplitude bumped 180 → 210 so pickets touch close to top + bottom playable edges at extremes (was cruisable through top/bottom lanes). Reclassified hard → expert per playtest ("probably the first expert one i have seen"). |
