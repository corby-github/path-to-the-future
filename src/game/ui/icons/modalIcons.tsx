...
export const IconStayLate: ModalIconComponent = ({ palette, size }) => (
  <IconFrame
    palette={palette}
...
export const IconStandupTooLong: ModalIconComponent = ({ palette, size }) => (
  <IconFrame
    palette={palette}
...
export const IconPandemicFurlough: ModalIconComponent = ({ palette, size }) => (
  <IconFrame
    palette={palette}
...
export const IconLightbulbIdea: ModalIconComponent = ({ palette, size }) => (
  <IconFrame
    palette={palette}
