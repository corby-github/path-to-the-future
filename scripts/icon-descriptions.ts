...
export const ICON_DESCRIPTIONS: Record<string, string> = {
  ...
  IconAiTutor: 'laptop with a sparkle on screen — the AI tutor product',
  IconReadingStruggle: 'open book with a "?" on the right page — letters that won\'t settle',
  IconCollegePrepFork: 'mortarboard above three diverging paths — college-prep route',
  IconTestPortfolio: 'bubble-sheet test next to a portfolio folder — test or portfolio',
  IconContractRemote: 'document with folded corner and a pen — contract work offer',
  IconCreativeBrush: 'paintbrush on a diagonal over a single brush stroke — creative project',
  IconEvaluationClipboard: 'clipboard with a checklist, top item ticked — end-of-year evaluation',
  IconGraduationCap: 'mortarboard with a tassel hanging right — graduation frame',
  IconEmptyBedroom: 'neatly-made bed under a small window — empty bedroom',
  IconMentalHealthFlag: 'figure raising a small flag — mental-health flag',
  IconReentryBriefcase: 'briefcase with a curved return-arrow — mid-career re-entry',
  IconCutCheck: 'paycheck with a heavy downward arrow — spouse furlough cut',
  IconSchoolBus: 'school bus from the side — back-to-school wave',
  IconRecitalCollision: 'piano keys beside a party hat — recital vs. fortieth',
  IconTeenPhoneRequest: 'smartphone with a chat-bubble glyph on screen — teen wants a phone',
  IconTwoTeensHeart: 'two teen figures with a small heart between — teen dating',
  IconLateNightDoor: 'door cracked open with a crescent moon outside — late-night come-home',
  IconWelderTorch: 'welding torch on a diagonal with a spark cluster — trade-school suggestion',
  IconBlankPlanner: 'blank weekly planner grid with a "?" in the center — unschooling week',

  // --- Homeschool pack — late-decade coverage push (events) ----------------
  IconKidChatbot: 'monitor showing a chat bubble beside a small kid — kid asks the chatbot',
  IconEssaySparkle: 'document with a sparkle in the corner — essay sounded different',
  IconCheckoutScreen: 'kiosk screen on a stand above a barcode — cashier-less checkout',
  IconLaptopWorkflow: 'laptop with a gear on screen and speed-marks — workflow halved',
  IconBakeSale: 'two cookies beside a price tag — bake-sale cleared',
  IconPhotoFrame: 'standing photo frame with two figures inside — decade photo',
  IconFieldTripMishap: 'museum with columns + a closed-line barrier — field-trip mishap',
  IconChapterBook: 'closed thick book with a bookmark — first chapter book',
  IconChurchOpen: 'church silhouette with a cross — church stayed open',
  IconShoppingCart: 'shopping cart with a few items — early-morning grocery line',
  IconPhoneText: 'smartphone with a chat bubble drifting right — text from relatives',
  IconYardFriends: 'two figures across a dashed property-line, small heart over it — driveway friends',
  IconBackToSchool: 'school building with a bell-tower — friends return to brick-and-mortar',
  IconLayoffPackage: 'manila folder on a kitchen-table edge — layoff package',
  IconMarkerOnWall: 'wavy scribble across a wall + a marker on the diagonal — toddler marker',
  IconCollegeNumber: 'mortarboard above a heavy "$$$" — college sticker price',
  IconResumeDoc: 'document with avatar circle and section headings — spouse on the job market',
